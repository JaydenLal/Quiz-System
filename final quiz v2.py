...
answer = input("\nQ1 Who directed Lord of the Rings? ").lower()
score = 0
...
# Question 2
answer = input("\nQ2 Where was Lord of the Rings Directed? ").lower()
...
# Question 4
answer = input('\nQ4 What NZ city served as the primary filming '
    'location for the Shire? ').lower()
if answer == "matamata":
    score = score + 2
    print("You're correct!")
...
answer = input("\nQ6: What is the name of the New Zealand special effects and prop company "
       "that created many of the creatures and weapons for the film? ").lower()
...
# Question 7
answer = input("\nQ7 Which New Zealand actor played the role of Éomer? ").lower()
